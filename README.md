...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/click-shell-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9457&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/click-shell-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `click-shell` can be installed with:

```
conda install click-shell
```

It is possible to list all of the versions of `click-shell` available on your platform with:
